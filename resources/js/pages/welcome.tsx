...
const section2 = [
    ...
    {
        "title": "Garansi Mendapatkan Job di Perusahaan Terbaik",
        "deskripsi": "Kami mendapatkan rekomendasi dari top tech companies untuk memberikan kesempatan kepada para student Harada Internasional Center untuk mendapatkan job di perusahaan terbaik."
    },
    {
    ...
    {
        "title": "Panduan Karir Personalized Selamanya",
        "deskripsi": "Tim Talent Support kami secara profesional akan selalu siap melayani para students Harada Internasional Center selama bootcamp berlangsung dan setelah kelulusan."
    },
    {
        "title": "20 Mentor Terbaik & Berkualitas",
    ...
    {
        "title": "Networking Berkualitas Bersama Ratusan Member Community Harada Internasional Center",
        "deskripsi": "Para alumni Harada Internasional Center akan diberikan akses untuk saling berinteraksi dengan alumni dan community Harada Internasional Center lainnya yang telah bekerja di perusahaan besar untuk memperluas networking."
    },
    {
        "title": "Pengalaman Magang Nyata dan Final Project",
        "deskripsi": "Kami akan memberikan kesempatan kepada para student Harada Internasional Center untuk mendapatkan pengalaman kerja secara nyata dan pengerjaan real project untuk dijadikan portofolio yang valuable."
    },
];
    ...
    return (
        <>
            ...
            <div className="flex min-h-screen flex-col items-center bg-white  text-[#1b1b18]  dark:bg-[#0a0a0a]">
                ...
                {/* <Hero /> */}
                    {/* top */}
                    <div className='bg-white w-full h-full pb-5 '>
                    ...
                    <div className="flex justify-center w-full lg:py-10 py-5  bg-[#2C3D6D]">
                        <div className="flex gap-10 justify-around text-white">
                            ...
                            <div className="flex lg:flex-row flex-col gap-3 items-center">
                                <h3 className='lg:text-[40px] text-xl font-bold text-[#BAF81B]'>99%</h3>
                                <p className='w-[80px] lg:text-[16px] text-[13px]'>Students Got Hired </p>
                            </div>
                            <div className="flex lg:flex-row flex-col gap-3 items-center">
                                <h3 className='lg:text-[40px] text-xl font-bold text-[#BAF81B]'>100+</h3>
                                ...
                                <div data-aos="fade-up" className="grid grid-cols-2 lg:gap-10 gap-3">
                                    {section2.map((item, index) => (
                                        <div className="" key={index}>
                                            <h3 className='font-extrabold text-[#2C3D6D]'>{item.title}</h3>
